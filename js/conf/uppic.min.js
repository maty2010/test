 ...
 * @Author: matianye@ 
 * @Date: 2017-11-13 11:35:17 
 * @Last Modified by: matianye@
 * @Last Modified time: 2017-11-21 16:22:19
*/

__webpack_require__ (9);
__webpack_require__ (10);
__webpack_require__ (12);
var PhotoClip = __webpack_require__(13)
// 图片上传、移动、放大缩小、裁剪

__webpack_require__ (17);
var Canvas2Image = __webpack_require__ (18);
// console.log(require ('canvas2image').convertToImage())
// require ('../common/base64');
// 生成图片

// ==========canvas2image==========
//  function init () {
//     canvasT = document.getElementById('thecanvas');
...
//         var w = $imgW.value,
//             h = $imgH.value;
//         $imgs.appendChild(Canvas2Image.convertToImage(canvasT, w, h))
//         console.log(canvasT)
//     }
// }
// onload = init;
...
$('.J-btn-yz').click(function(){
    var v=$('.user-name').find('input').val();
    if(!v){
        alert('用户名不能为空')
        $('#file').show();
    }
...
$('#file').click(function(){
    setTimeout(function(){
        // var userName = $('.user-name').find('input').val();
        // var userTit = $('.user-tit').find('input').val();
        // var userTxar = $('.user-txar').find('textarea').val().replace(/^ +| +$/g,'');
        // var userTxar = $('.user-txar').find('.txar').html();
        // userTxar2=userTxar.replace(/\n|\r\n/gm,"<br />");
        $('.J-hide').hide();
        $('.infobg').css('margin',"0 .31rem");
        $('.text-top').hide();
        $('.clip-bot').show();
        // $('.iptbox > *').hide();
        // $('.iptbox > .txt-var').show();
        $('.btn-up').hide();
        // $('.name-val').show().text(userName);
        // $('.tit-val').show().text(userTit);
        // $('.txar-val').show().html(userTxar);

        $('.iptbox').addClass('iptbox_no');
        $('.qr-code').show();

        var userTit = $('.user-tit').find('.ipt').val();
        if(!userTit){
            $('.user-tit').find('.ipt').hide();
        }

        var userTxar = $('.user-txar').find('.txar').val();
        if(!userTxar){
            $('.user-txar').find('.txar').hide();
        }
    },3000)
});
// ========== 上传照片隐藏其他内容 ==========
...
$(".clipBtn").click(function(){
    ...
    $('.infobg').css('margin',"0");
    $('.J-btn-up').hide();
    $('.J-btnSave').css('display','inline-block');
    $('.J-btns').css('display','none')
});
// ========== 点击确定按钮，裁剪图片层显示 ==========
...
$('.J-c1').click(function(){
	$(this).addClass('hide');
	$('.J-c2').removeClass('hide');
	$('.iptbox').removeClass('ipt-c1').addClass('ipt-c2');
})
$('.J-c2').click(function(){
	$(this).addClass('hide');
	$('.J-c3').removeClass('hide');
    $('.iptbox').removeClass('ipt-c2').addClass('ipt-c3');
})
$('.J-c3').click(function(){
	$(this).addClass('hide');
	$('.J-c1').removeClass('hide');
	$('.iptbox').removeClass('ipt-c3').addClass('ipt-c1');
})
// ========== 切换颜色 ==========


$('.J-secbtn').click(function(){
    $('.layer-wrap').show();
});
$('.J-cloes').click(function(){
    $('.layer-wrap').hide();
});
$('.J-radio').click(function(){
    $('.r-icn').removeClass('active');
    $(this).find('.r-icn').addClass('active');
    // $('.user-txar').find('.txar').html($(this).find('.flex1').html());
    // $('.user-txar').find('.txar').text($(this).find('.flex1').html());
    var tempHtml = '';
    var $ps = $(this).find('.flex1 p');
    for(var i=0;i<$ps.length;i++){
        tempHtml += $ps[i].innerText + '\n';
    }
    $('.user-txar').find('.txar').text(tempHtml);
});
// $('.btn').click(function(){
//     var tempHtml = '';
//     var $ps = $(this).find('.flex1 p');
...
//      tempHtml += $ps[i].innerText + '\n';
//     }
//     // $('.user-txar').find('.txar').text($(this).find('.flex1').text());
//     $('.user-txar').find('.txar').text(tempHtml);
// })
// $('.J-radio').eq(0).click();
// ========== 弹层选择 ==========
...
//             newImg.src =  dataUrl;
//             document.getElementById('imagesId').appendChild(newImg);
//         }
//     });
// };
// ========== 生成图片 ==========
...
// ==========canvas2image==========
//  function init () {
//     canvasT = document.getElementById('cvs');
//     $button = document.getElementById('button');
//     $imgs = document.getElementById('imgs');
//     bind();
// }
...
//     $button.onclick = function (e) {
//         // console.log(111)
//         $imgs.appendChild(Canvas2Image.saveAsImage(canvasT))
//         console.log(canvasT)
//     }
// }
// onload = init;
...
btnId.onclick = function(){
	html2canvas(contentId, {
        onrendered: function(canvas) {  
			...
			//读取属性值
            document.getElementById('imagesId').appendChild(canvas);


            // ==========canvas2image src_5==========
            // canvasT = document.getElementById('thecanvas');
            // $imgs = document.getElementById('imgs');
            // $imgs.appendChild(Canvas2Image.convertToImage(canvasT))
            // alert($imgs.appendChild(Canvas2Image.convertToImage(canvasT)))
            // ==========canvas2image src_5==========
            ...
            // var oCavs = document.getElementById("thecanvas");
            // var imgData = Cavs2Img.saveAsPNG(oCavs, true).getAttribute('src');
            // var imgSrc = imgData;
            // console.log(oCavs)
            // document.getElementById("imgID").src=imgSrc;
            // Cavs2Img.saveAsPNG(oCavs);
            ...
            // setTimeout(function(){
            //     var cavSrc = canvas.toDataURL("image/png");
            //     // console.log(cavSrc)
            //     var imgSrc = cavSrc;
            //     // console.log(imgSrc)
            ...
            // var imgData = Canvas2Image.saveAsPNG(oCavs, true).getAttribute('src');
